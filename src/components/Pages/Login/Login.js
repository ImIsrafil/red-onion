      ...
      <div className='w-full '>
        <div className='max-w-sm m-auto bg-white rounded-md shadow-md'>
          ...
          <div className='flex flex-col gap-5 items-center'>
            <input className='px-5 py-2 w-full' type="email" name="email" id="email" placeholder='Email' />
            <input className='px-5 py-2 w-full' type="password" name="password" id="password" placeholder='Password' />
            <button className='w-[150px] py-2 text-center text-base text-gray-50 rounded bg-red-700' type='submit'>Submit</button>
          </div>
